...
|-----------|------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------|----------------|
| master    | 1.11.15-2025.1.x(推荐)               | 2025.1.1 ([other version](https://mvnrepository.com/artifact/org.springframework.cloud/spring-cloud-dependencies/versions "Select a version of 2025.1.x without security vulnerabilities")) | 4.0.5 ([other version](https://mvnrepository.com/artifact/org.springframework.boot/spring-boot/versions "Select a version of 4.0.x without security vulnerabilities"))  | OpenJDK 17         |                |
| master    | 1.11.15-2025.0.x(推荐)               | 2025.0.1 ([other version](https://mvnrepository.com/artifact/org.springframework.cloud/spring-cloud-dependencies/versions "Select a version of 2025.0.x without security vulnerabilities")) | 3.5.13 ([other version](https://mvnrepository.com/artifact/org.springframework.boot/spring-boot/versions "Select a version of 3.5.x without security vulnerabilities")) | OpenJDK 17         |                |
| master    | 1.11.15-2024.0.x                   | 2024.0.3 ([other version](https://mvnrepository.com/artifact/org.springframework.cloud/spring-cloud-dependencies/versions "Select a version of 2024.0.x without security vulnerabilities")) | 3.4.13 ([other version](https://mvnrepository.com/artifact/org.springframework.boot/spring-boot/versions "Select a version of 3.4.x without security vulnerabilities")) | OpenJDK 17         |                |
| 2023.0.x  | 1.11.14-2023.0.x                   | 2023.0.6                                                                                                                                                                                    | 3.3.13                                                                                                                                                                  | OpenJDK 17         | End of Support |
| 2022.0.x  | 1.11.10-2022.0.x                   | 2022.0.5                                                                                                                                                                                    | 3.1.12                                                                                                                                                                  | OpenJDK 17         | End of Support |
| 2021.0.x  | 1.11.15-2021.0.x(推荐)               | 2021.0.9 ([other version](https://mvnrepository.com/artifact/org.springframework.cloud/spring-cloud-dependencies/versions "Select a version of 2021.0.x without security vulnerabilities")) | 2.7.18 ([other version](https://mvnrepository.com/artifact/org.springframework.boot/spring-boot/versions "Select a version of 2.7.x without security vulnerabilities")) | OpenJDK 8          | Vulnerability  |
...
* Spring Cloud Edgeware, Finchley, Greenwich, Hoxton, 2020.0.x, 2022.0.x, 2023.0.x have all reached end of life status and
