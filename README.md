...
|-----------|------------------------------------|-------------------------------|------------------------------|--------------------|----------------|
| master    | 1.11.14-2024.0.x(推荐)               | 2024.0.3                      | 3.4.13                       | OpenJDK 17         |                |
| 2023.0.x  | 1.11.14-2023.0.x(推荐)               | 2023.0.6                      | 3.3.13                       | OpenJDK 17         |                |
| 2022.0.x  | 1.11.10-2022.0.x                   | 2022.0.5                      | 3.1.12                       | OpenJDK 17         | End of Support |
| 2021.0.x  | 1.11.14-2021.0.x(推荐)               | 2021.0.9                      | 2.7.18                       | OpenJDK 8          | Vulnerability  |
