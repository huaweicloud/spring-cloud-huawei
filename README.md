...
|-----------|------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------|--------------------|----------------|
| master    | 1.11.15-2024.0.x(推荐)               | 2024.0.3 ([other version](https://mvnrepository.com/artifact/org.springframework.cloud/spring-cloud-dependencies/versions "选择2024.0.x且无安全漏洞的版本")) | 3.4.13 ([other version](https://mvnrepository.com/artifact/org.springframework.boot/spring-boot/versions "选择3.4.x且无安全漏洞的版本"))   | OpenJDK 17         |                |
...
| 2021.0.x  | 1.11.15-2021.0.x(推荐)               | 2021.0.9 ([other version](https://mvnrepository.com/artifact/org.springframework.cloud/spring-cloud-dependencies/versions "选择2021.0.x且无安全漏洞的版本")) | 2.7.18 ([other version](https://mvnrepository.com/artifact/org.springframework.boot/spring-boot/versions "选择2.7.x且无安全漏洞的版本"))   | OpenJDK 8          | Vulnerability  |
