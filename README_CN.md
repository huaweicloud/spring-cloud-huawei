...
| 分支        | 最新版本                 | Spring Cloud编译版本                                                                                                                         | 编译使用Spring Boot版本                                                                                                    | 支持的JDK版本   | 备注   |
|-----------|----------------------|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|------------|------|
| master    | 1.11.15-2025.1.x(推荐) | 2025.1.1 ([其他版本](https://mvnrepository.com/artifact/org.springframework.cloud/spring-cloud-dependencies/versions "选择2025.1.x且无安全漏洞的版本")) | 4.0.5 ([其他版本](https://mvnrepository.com/artifact/org.springframework.boot/spring-boot/versions "选择4.0.x且无安全漏洞的版本"))  | OpenJDK 17 |      | 
| master    | 1.11.15-2025.0.x(推荐) | 2025.0.1 ([其他版本](https://mvnrepository.com/artifact/org.springframework.cloud/spring-cloud-dependencies/versions "选择2025.0.x且无安全漏洞的版本")) | 3.5.13 ([其他版本](https://mvnrepository.com/artifact/org.springframework.boot/spring-boot/versions "选择3.5.x且无安全漏洞的版本")) | OpenJDK 17 |      | 
| master    | 1.11.15-2024.0.x     | 2024.0.3 ([其他版本](https://mvnrepository.com/artifact/org.springframework.cloud/spring-cloud-dependencies/versions "选择2024.0.x且无安全漏洞的版本")) | 3.4.13 ([其他版本](https://mvnrepository.com/artifact/org.springframework.boot/spring-boot/versions "选择3.4.x且无安全漏洞的版本")) | OpenJDK 17 |      | 
| 2023.0.x  | 1.11.14-2023.0.x     | 2023.0.6                                                                                                                                 | 3.3.13                                                                                                               | OpenJDK 17 | 停止更新 | 
| 2022.0.x  | 1.11.11-2022.0.x     | 2022.0.5                                                                                                                                 | 3.1.12                                                                                                               | OpenJDK 17 | 停止更新 | 
| 2021.0.x  | 1.11.15-2021.0.x(推荐) | 2021.0.9 ([其他版本](https://mvnrepository.com/artifact/org.springframework.cloud/spring-cloud-dependencies/versions "选择2021.0.x且无安全漏洞的版本")) | 2.7.18 ([其他版本](https://mvnrepository.com/artifact/org.springframework.boot/spring-boot/versions "选择2.7.x且无安全漏洞的版本")) | OpenJDK 8  | 存在漏洞 | 
...
***注意：***
* 尽快更新到Spring社区维护的OOS版本2024.0.x分支，因为2021.0.x分支依赖的Spring 5.3.x存在一定的漏洞，暂时未提供开源版本修复。
* 使用`Spring Cloud Huawei`时可以使用兼容的`Spring Cloud`版本。详细信息可参考 https://spring.io/projects/spring-cloud 。
* Spring Cloud Edgeware, Finchley, Greenwich, Hoxton, 2020.0.x, 2022.0.x, 2023.0.x 已经停止演进，不建议在生产环境使用。
