...
public class NacosConfigServiceStandbyManager implements NacosConfigServiceManager {
      ...
      synchronized (NacosConfigServiceMasterManager.class) {
        if (Objects.isNull(configService)) {
          try {
            ...
            throw new IllegalStateException("build nacosConfigServiceStandby failed.", e);
          }
        }
      }
    }
