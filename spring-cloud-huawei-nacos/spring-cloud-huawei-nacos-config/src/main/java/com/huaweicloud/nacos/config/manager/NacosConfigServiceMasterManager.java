...
public class NacosConfigServiceMasterManager implements NacosConfigServiceManager {
      ...
      synchronized (NacosConfigServiceMasterManager.class) {
        if (Objects.isNull(configService)) {
          try {
            ...
            throw new IllegalStateException("build nacosConfigServiceMaster failed.", e);
          }
        }
      }
    }
