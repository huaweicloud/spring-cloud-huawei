...
public class MetricsPreHandlerInterceptor implements PreHandlerInterceptor {
  @Override
  public boolean handle(HttpServletRequest request, HttpServletResponse response, Object handler) {
    ...
    context.putLocalContext(InvocationMetrics.CONTEXT_OPERATION, buildOperation(request));
    return true;
  }
