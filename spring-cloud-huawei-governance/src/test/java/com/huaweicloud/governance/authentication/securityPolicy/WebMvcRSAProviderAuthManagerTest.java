...
import com.huaweicloud.governance.authentication.webmvc.WebMvcRSAProviderAuthManager;

public class WebMvcRSAProviderAuthManagerTest {
  private Environment environment = Mockito.mock(Environment.class);

  private WebMvcRSAProviderAuthManager manager
      = new WebMvcRSAProviderAuthManager(null, environment, null);
