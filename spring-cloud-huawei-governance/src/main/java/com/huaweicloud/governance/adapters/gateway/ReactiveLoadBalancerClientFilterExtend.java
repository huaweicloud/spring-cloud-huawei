...
public class ReactiveLoadBalancerClientFilterExtend extends ReactiveLoadBalancerClientFilter {
	...
	private static final Log log = LogFactory.getLog(ReactiveLoadBalancerClientFilterExtend.class);

	private final LoadBalancerClientFactory clientFactory;

	private final GatewayLoadBalancerProperties properties;

	public ReactiveLoadBalancerClientFilterExtend(LoadBalancerClientFactory clientFactory,
	...
	public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
		...
		if (log.isTraceEnabled()) {
			log.trace(ReactiveLoadBalancerClientFilterExtend.class.getSimpleName() + " url before: " + url);
		}
